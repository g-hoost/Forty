        ...
        <div classname="md:block">
          ...
          <ul>
            {this.state.item.strIngredient1 && (
              <li>{this.state.item.strMeasure1}{this.state.item.strIngredient1}</li>
            )}
            {this.state.item.strIngredient2 && (
              <li>{this.state.item.strMeasure2}{this.state.item.strIngredient2}</li>
            )}
            {this.state.item.strIngredient3 && (
              <li>{this.state.item.strMeasure3}{this.state.item.strIngredient3}</li>
            )}
            {this.state.item.strIngredient4 && (
              <li>{this.state.item.strMeasure4}{this.state.item.strIngredient4}</li>
            )}
            {this.state.item.strIngredient5 && (
              <li>{this.state.item.strMeasure5}{this.state.item.strIngredient5}</li>
            )}
            {this.state.item.strIngredient6 && (
              <li>{this.state.item.strMeasure6}{this.state.item.strIngredient6}</li>
            )}
            {this.state.item.strIngredient7 && (
              <li>{this.state.item.strMeasure7}{this.state.item.strIngredient7}</li>
            )}
            {this.state.item.strIngredient8 && (
              <li>{this.state.item.strMeasure8}{this.state.item.strIngredient8}</li>
            )}
            {this.state.item.strIngredient9 && (
              <li>{this.state.item.strMeasure9}{this.state.item.strIngredient9}</li>
            )}
            {this.state.item.strIngredient10 && (
              <li>{this.state.item.strMeasure10}{this.state.item.strIngredient10}</li>
            )}
            {this.state.item.strIngredient11 && (
              <li>{this.state.item.strMeasure11}{this.state.item.strIngredient11}</li>
            )}
            {this.state.item.strIngredient12 && (
              <li>{this.state.item.strMeasure12}{this.state.item.strIngredient12}</li>
            )}
            {this.state.item.strIngredient13 && (
              <li>{this.state.item.strMeasure13}{this.state.item.strIngredient13}</li>
            )}
            {this.state.item.strIngredient14 && (
              <li>{this.state.item.strMeasure14}{this.state.item.strIngredient14}</li>
            )}
            {this.state.item.strIngredient15 && (
              <li>{this.state.item.strMeasure15}{this.state.item.strIngredient15}</li>
            )}
          </ul>
